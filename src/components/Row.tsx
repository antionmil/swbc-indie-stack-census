...
/**
 * One line of the ledger: a name, a leader, a figure — and underneath, in
 * small type, the string in the response that put the name there.
 *
    ...
    >
      <span className="flex items-baseline gap-3">
        ...
        <span className="tnum font-mono text-[15px] font-semibold whitespace-nowrap">
          {count}
          <span className="text-faint font-normal">/{of}</span>
        </span>
      </span>
      {(note || evidence) && (

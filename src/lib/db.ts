 ...
 *
 * Every read on this site is one aggregate or one filtered list, and the query
 * planner does a better job of those written as SQL than the ORM does written
 * as a chain. Drizzle stays for the schema and `db:push`; the queries are SQL.
 */
